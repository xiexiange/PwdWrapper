...
public class SplashActivity extends Activity implements SplashADListener {
    ...
    private static final String TAG_AD = TAG + "_AD";
...
//        return TextUtils.isEmpty(posId) ? Constant.SplashPosID : posId;
    ...
    public void onADPresent() {
        TLog.e(TAG_AD, "SplashADPresent");
    }

    @Override
    public void onADClicked() {
        TLog.e(TAG_AD, "SplashADClicked clickUrl: "
    ...
    public void onADTick(long millisUntilFinished) {
        TLog.e(TAG_AD, "SplashADTick " + millisUntilFinished + "ms");
        skipView.setText(String.format(SKIP_TEXT, Math.round(millisUntilFinished / 1000f)));
    }

    @Override
    public void onADExposure() {
        TLog.e(TAG_AD, "SplashADExposure");
    }

    @Override
    public void onADDismissed() {
        TLog.e(TAG_AD, "SplashADDismissed");
        next();
    }
